;; doom-cspk-theme.el --- inspired by morhetz Cspk -*- no-byte-compile: t; -*-
(require 'doom-themes)
...
;;
(defgroup doom-cspk-theme nil
  "Options for doom-cspk."
  :group 'doom-themes)

(defcustom doom-cspk-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-cspk-theme
  :type 'boolean)

(defcustom doom-cspk-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-cspk-theme
  :type '(choice integer boolean))

(defcustom doom-cspk-dark-variant nil
...
;;
(def-doom-theme doom-cspk
  "Dark theme with pastel 'retro groove' colors."

  ;; name        gui       256       16
  ((bg
    (cond ((equal doom-cspk-dark-variant "hard") '("#1d2021" "#1e1e1e" nil))   ; bg0_h
          ((equal doom-cspk-dark-variant "soft") '("#32302f" "#323232" nil))   ; bg0_s
          (t                                     '("#282828" "#282828" nil)))) ; bg0
   (bg-alt
    (cond ((equal doom-cspk-dark-variant "hard") '("#282828" "#1e1e1e" nil))
          ((equal doom-cspk-dark-variant "soft") '("#32302f" "#323232" nil))
          (t                                     '("#3a3a3a" "#3a3a3a" nil))))
   (bg-alt2    '("#5a5a5a" "#5a5a5a" "ligthgrey"      )) ; bg2 (for region, selection etc.)
   ...
   (fg         '("#dadada" "#dadada" "brightwhite")) ; fg/fg1
   (fg-alt     '("#d5c4a1" "#cccccc" "brightwhite")) ; fg2

   ;; Standardized official colours from cspk
   (grey       '("#8a8a8a" "#8a8a8a" "brightblack"))   ; gray
   (red        '("#fb4934" "#e74c3c" "red"))           ; bright-red
   (magenta    '("#ffafaf" "#ffafaf" "magenta"))       ; red
   (violet     '("#d3869b" "#d3869b" "brightmagenta")) ; bright-purple
   (orange     '("#ffaf5f" "#ffaf5f" "orange"))        ; bright-orange
   (yellow     '("#ffd787" "#ffd787" "yellow"))        ; bright-yellow
   (teal       '("#8ec07c" "#8ec07c" "green"))         ; bright-aqua
   (green      '("#b8bb26" "#b8bb26" "green"))         ; bright-green
   (dark-green '("#98971a" "#98971a" "green"))         ; green
   (blue       '("#87afff" "#87afff" "brightblue"))    ; bright-blue
   ...
   (selection      bg-alt2)
   (builtin        orange)
   (comments       (if doom-cspk-brighter-comments magenta grey))
   (doc-comments   (if doom-cspk-brighter-comments (doom-lighten magenta 0.2) (doom-lighten fg-alt 0.25)))
   (constants      fg)
   (functions      fg)
   (keywords       yellow)
   (methods        fg)
   ...
   ;; custom categories
   (-modeline-pad
    (when doom-cspk-padded-modeline
      (if (integerp doom-cspk-padded-modeline)
          doom-cspk-padded-modeline
        4)))
  ...
  (
   ...
   ((line-number &override) :foreground (doom-darken grey 0.15))
   ((line-number-current-line &override) :background bg-alt2 :foreground fg :bold t)

   (font-lock-preprocessor-face :foreground teal :bold nil)
   (font-lock-constant-face :foreground blue :bold nil)
   (highlight-numbers-number :foreground fg :bold nil)
